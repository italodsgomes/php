/**
 * backbone model definitions for AVIACAO
 */
...
/**
 * Aeronave Backbone Model
 */
model.AeronaveModel = Backbone.Model.extend({
	urlRoot: 'api/aeronave',
	idAttribute: 'id',
	id: '',
	idCliente: '',
	matricula: '',
...
/**
 * Aeronave Backbone Collection
 */
model.AeronaveCollection = model.AbstractCollection.extend({
	url: 'api/aeronaves',
	model: model.AeronaveModel
});
