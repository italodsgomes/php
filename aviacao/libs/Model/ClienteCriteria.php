...
require_once("DAO/ClienteCriteriaDAO.php");

/**
 * The ClienteCriteria class extends ClienteDAOCriteria and is used
 ...
 * @version 1.0
 */
class ClienteCriteria extends ClienteCriteriaDAO
{
