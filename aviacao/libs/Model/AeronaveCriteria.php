...
require_once("DAO/AeronaveCriteriaDAO.php");

/**
 * The AeronaveCriteria class extends AeronaveDAOCriteria and is used
 ...
 * @version 1.0
 */
class AeronaveCriteria extends AeronaveCriteriaDAO
{
